 ...
 * Use the {@link FourByFourFragment#newInstance} factory method to
...
public class FourByFourFragment extends Fragment {
    ...
    FourGridGamePlay game1 = new FourGridGamePlay();
    ...
    public FourByFourFragment() {
        ...
        trackedData.setMovesLeftCount(9);
     ...
     * @return A new instance of fragment fourByFourFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static FourByFourFragment newInstance(String param1, String param2) {
        FourByFourFragment fragment = new FourByFourFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_four_by_four, container, false);
        // Inflate the layout for this fragment
        //
    ...
    public void handleImageViewClick(ImageView imageView,int[][] board,int row,int col) {
        ...
        {   countView.setText("");
            ...
            if (PlayerMap.get(imageView) == 0) {
                ...
                if (MainActivity.winCondition == 3 && FourGridGamePlay.checkThreeConsecutiveWin(board, 1) ) {

                    Notification.showWin(getContext(), 4);
                    trackedData.cancelPlayerTimer();
                    timerView.setText("");
                }else if (MainActivity.winCondition == 3 && FourGridGamePlay.checkThreeConsecutiveWin(board, 0) ) {

                    Notification.showWin2(getContext(), 4);
                    trackedData.cancelPlayerTimer();
                    timerView.setText("");
                }else if (MainActivity.winCondition == 4 && FourGridGamePlay.checkFourConsecutiveWin(board, 1) ) {

                    Notification.showWin(getContext(), 4);
                    trackedData.cancelPlayerTimer();
                    timerView.setText("");
                }else if (MainActivity.winCondition == 4 && FourGridGamePlay.checkFourConsecutiveWin(board, 0) ) {

                    Notification.showWin2(getContext(), 4);
                    trackedData.cancelPlayerTimer();
                    timerView.setText("");
                } else if (FourGridGamePlay.checkDraw(board)) {
                    Notification.showDraw(getContext(), 4);
                    trackedData.cancelPlayerTimer();
                    timerView.setText("");
                }
            }
        ...
        else
        {
            ...
            if (PlayerMap.get(imageView) == 0)
            {
                ...
                if (MainActivity.winCondition == 4 && FourGridGamePlay.checkFourConsecutiveWin(board, 1) ) {
                    ...
                    if (!unclickedImageViews.isEmpty()) {
                        ...
                        tracker.startPlayerTurnTimer(1000, new Tracker.OnTimerTickListener() {
                            ...
                            public void onTick(long millisUntilFinished) {
                                // Update the timerView with the remaining time
                                long secondsRemaining = millisUntilFinished / 1000;
                                //timerView.setText("Time left: " + secondsRemaining + " seconds");
                            }
                            ...
                            public void onFinish() {
                                ...
                                if (MainActivity.winCondition == 3 && FourGridGamePlay.checkThreeConsecutiveWin(board, 0) ) {

                                    Notification.showWin(getContext(), 4);
                                    trackedData.cancelPlayerTimer();
                                    timerView.setText("");
                                }
                                if (MainActivity.winCondition == 4 && FourGridGamePlay.checkFourConsecutiveWin(board, 0) ) {
